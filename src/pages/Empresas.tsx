...
export default function Empresas() {
  return (
    <>
      <SEO
        title="Recrutamento e Seleção para Empresas | Contratar Funcionários | J&S"
        description="Encontramos os profissionais certos para sua empresa. Mão de obra temporária e efetiva, recrutamento seletivo e banco de talentos."
        keywords={[
          ...
          <Container>
            ...
            >
              ...
              <p className="text-muted-foreground mx-auto mt-4 max-w-2xl text-lg">
                ...
                do mercado através de recrutamento, seleção e banco de
                candidatos.
              </p>
            </motion.div>

  ...
  return (
    <>
      <SEO
        ...
        description="Conectamos talentos às melhores oportunidades. Encontre vagas de emprego ou encontre profissionais qualificados para sua empresa. Mão de obra temporária e efetiva."
        keywords={[
          'agência de empregos',
          'recrutamento',
          'seleção de pessoas',
            ...
            >
              <Link to="/trabalhe-conosco">
                ...
                >
                  ...
                  <p className="text-muted-foreground mb-6 max-w-xs text-sm">
                    Cadastre seu currículo, encontre vagas compatíveis e
              ...
              <Link to="/empresas">
                ...
                >
                  ...
                  <p className="text-muted-foreground mb-6 max-w-xs text-sm">
                    Encontre os profissionais certos para sua empresa. Soluções
          ...
          <Container>
            ...
            >
              ...
              <motion.p
                ...
                className="text-muted-foreground mx-auto mt-4 max-w-2xl text-lg"
              >
                Mais de {COMPANY.clientsServed} empresas utilizam nossos
                serviços de RH e facilities.
              </motion.p>
            </motion.div>

...
export default function Sobre() {
  return (
    <>
      <SEO
        title="Sobre Nós — J&S Terceirizados | Agência de Empregos e RH"
        description="A J&S Terceirizados Ltda. é especializada em oferecer soluções de terceirização de mão de obra temporária e efetiva e facilities."
        keywords={[
          'sobre nós',
          'J&S Terceirizados',
        ...
        <Section className="pt-20 md:pt-28">
          <Container>
            ...
            >
              ...
              >
                A J&S Terceirizados Ltda. é especializada em oferecer soluções
                de terceirização de mão de obra temporária e efetiva e
                facilities, buscando otimizar gestão e eficiência operacional
                dos clientes.
              </motion.p>
            </motion.div>
            ...
            >
              <motion.div variants={staggerItem('left')}>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Conectar empresas aos profissionais certos e ajudar candidatos
                  a conquistarem novas oportunidades, por meio de recrutamento,
                ...
                <p className="text-muted-foreground leading-relaxed">
                  Ser a referência em soluções de RH e terceirização,
